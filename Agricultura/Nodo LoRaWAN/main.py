...
# Esta prueba simula un nodo LoRaWAN que envía un mensaje cada 30 minutos de 10
...
# Generación de mensaje random de 10 bytes y espera de 60 segundos por generación
...
try:
    ...
    pass
machine.deepsleep(1800000) #30 minutos
